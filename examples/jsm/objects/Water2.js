...
class Water extends Mesh {
	...
	constructor( geometry, options = {} ) {
		...
		const normalMap0 = options.normalMap0 || textureLoader.load( 'ddd/textures/water/Water_1_M_Normal.jpg' );
		const normalMap1 = options.normalMap1 || textureLoader.load( 'ddd/textures/water/Water_2_M_Normal.jpg' );
