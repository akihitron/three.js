...
class SSAARenderPass extends Pass {
	 ...
	 */
	render( renderer, writeBuffer, readBuffer, deltaTime, maskActive, params/*, deltaTime, maskActive */ ) { // @DDD@
